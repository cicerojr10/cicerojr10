...
- 💼 **Portfólio pessoal** – Site construído com React, Tailwind CSS e Vite, hospedado no GitHub Pages com domínio personalizado.  
  🔗 https://www.cicerojrtechprofessional.software

- 📊 **[Visualização de Informação](https://github.com/cicerojr10/projeto_visualizacao_informacao)** – Análise e visualização de dados utilizando Python.

- 🏦 **[Banco Digital](https://github.com/cicerojr10/dio_desafio_bancoDeDados)** – Aplicação web com Java e Spring Boot modelando operações bancárias.

- 📚 **[Sistema de Biblioteca](https://github.com/cicerojr10/LibraryManagementSystem)** – Gerenciamento online de biblioteca com Spring Boot e H2 Database.

- 🤖 **[Classificador de Imagens com CNN](https://github.com/cicerojr10/redeNeuralML.git)** – Rede neural convolucional implementada em Python para classificação de imagens.
...
📄 **Sitemap do site:**  
[https://www.cicerojrtechprofessional.software/sitemap.xml](https://www.cicerojrtechprofessional.software/sitemap.xml)

---

✨ _Sempre aprendendo, evoluindo e compartilhando conhecimento!_
